...
# Load datasets
sym_des = pd.read_csv(r"C:\Users\user\Downloads\Disease_diagnosis system\dataset\symptoms_df.csv")
precautions = pd.read_csv(r"C:\Users\user\Downloads\Disease_diagnosis system\dataset\precautions_df.csv")
workout = pd.read_csv(r"C:\Users\user\Downloads\Disease_diagnosis system\dataset\workout_df.csv")
description = pd.read_csv(r"C:\Users\user\Downloads\Disease_diagnosis system\dataset\description.csv")
medications = pd.read_csv(r"C:\Users\user\Downloads\Disease_diagnosis system\dataset\medications.csv")
diets = pd.read_csv(r"C:\Users\user\Downloads\Disease_diagnosis system\dataset\diets.csv")

# Load model
Random_Forest = joblib.load(r"C:\Users\user\Downloads\Disease_diagnosis system\models\Random_Forest.pkl")

if not hasattr(Random_Forest, "predict"):
    raise ValueError("Random_Forest model was not loaded correctly!")

# Ensure feature names are ignored
...
def predict():
    # Handle GET requests with an informative message
    if request.method == 'GET':
        return jsonify({"error": "Please send a POST request with JSON data"}), 400
